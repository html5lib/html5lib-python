...
class HTMLSanitizerMixin(object):
    ...
    attr_val_is_uri = frozenset((
        'href', 'src', 'cite', 'action', 'longdesc', 'poster', 'background',
        'datasrc', 'dynsrc', 'lowsrc', 'ping', 'poster', 'xlink:href',
        'xml:base'))
